...
class sendmsg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:word3.sendmsg) */ {
 public:
  sendmsg();
  virtual ~sendmsg();
...
inline ::google::protobuf::int64 sendmsg::clientid() const {
  // @@protoc_insertion_point(field_get:word3.sendmsg.clientid)
  return clientid_;
}
inline void sendmsg::set_clientid(::google::protobuf::int64 value) {
